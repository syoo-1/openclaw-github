...
## 当前可用备份包
- 主脑备份：~/claw/current/backups/Brain-Backups/Brain-Canonical-2026-03-08-124526.tar.gz
- OpenClaw快照：~/claw/current/backups/OpenClaw-Backups/openclaw-home-2026-03-08-124526.tar.gz

## 快速恢复（当前版本）
### 只恢复主记忆
tar -xzf ~/claw/current/backups/Brain-Backups/Brain-Canonical-2026-03-08-124526.tar.gz -C ~

### 恢复 OpenClaw 状态
tar -xzf ~/claw/current/backups/OpenClaw-Backups/openclaw-home-2026-03-08-124526.tar.gz -C ~
